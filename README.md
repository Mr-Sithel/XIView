...
![Jumbled text example](https://github.com/Mr-Sithel/XIView/blob/master/Issue.png?raw=true)

<p></p>

Here's what it looks if you need to reference it.

![Fixed text example](https://github.com/Mr-Sithel/XIView/blob/master/Fixed.png?raw=true)
